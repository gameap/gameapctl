...
func checkWebServers(ctx context.Context, state panelInstallStateV3) (panelInstallStateV3, error) {
...
func checkNginxWebServer(ctx context.Context, state panelInstallStateV3) (panelInstallStateV3, error) {
...
func checkApacheWebServer(ctx context.Context, state panelInstallStateV3) (panelInstallStateV3, error) {
...
func checkPortAvailabilityV3(ctx context.Context, state panelInstallStateV3) (panelInstallStateV3, error) {
	if state.Port == "" {
		state.Port = "80"
	}
	...
	if err != nil {
		...
		if warningErr != nil {
			return state, errors.WithMessagef(err, "failed to check port availability")
		}
	} else {
		err = listener.Close()
		if err != nil {
...
func checkSELinux(ctx context.Context, state panelInstallStateV3) (panelInstallStateV3, error) {
