...
type panelInstallStateV3 struct {
	NonInteractive bool
	SkipWarnings   bool
...
func HandleV3(cliCtx *cli.Context) error {
	...
	if !state.NonInteractive {
		...
		answers, err := askUserV3(cliCtx.Context, state, needToAsk)
		if err != nil {
			return err
		}
...
func runMigrationWithRetry(ctx context.Context, state panelInstallStateV3) (panelInstallStateV3, error) {
...
func installSqlite(_ context.Context, state panelInstallStateV3) (panelInstallStateV3, error) {
	if !utils.IsFileExists(state.DBCreds.DatabaseName) {
		err := os.MkdirAll(state.Path, 0644)
		if err != nil {
			return state, errors.WithMessage(err, "failed to create directory for sqlite database")
		}
	}
...
func checkAndInstallPHP(
	ctx context.Context, pm packagemanager.PackageManager, state panelInstallStateV3,
) (panelInstallStateV3, error) {
...
func checkPHPExtensions(_ context.Context, state panelInstallStateV3) (panelInstallStateV3, error) {
...
func installGameAP(ctx context.Context, state panelInstallStateV3) (panelInstallStateV3, error) {
...
func daemonInstall(ctx context.Context, state panelInstallStateV3) (panelInstallStateV3, error) {
...
func updateAdminPassword(ctx context.Context, state panelInstallStateV3) (panelInstallStateV3, error) {
	var err error
...
func clearGameAPCache(ctx context.Context, state panelInstallStateV3) (panelInstallStateV3, error) {
...
func chownRGameapDirectory(ctx context.Context, state panelInstallStateV3) (panelInstallStateV3, error) {
	if state.OSInfo.Distribution != packagemanager.DistributionWindows {
...
func checkInstallation(ctx context.Context, state panelInstallStateV3) (panelInstallStateV3, error) {
	var err error
